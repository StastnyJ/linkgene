  ...
  return (
    <Container maxWidth="xl">
      ...
      <Typography textAlign="justify">
        We are... Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore
      ...
      <IconsContainer style={{ justifyContent: "space-evenly", marginBottom: 0 }}>
        <RouterCard text="For investors" icon={faHandHoldingUsd} onClick={() => {}} />
        <RouterCard text="For researchers" icon={faMicroscope} onClick={() => {}} />
      </IconsContainer>
      ...
      <br />
      <br />
      TODO: Investor information part <br />
      TODO: Researcher information part <br />
      TODO: Footer and links
    </Container>
  );
}
